...
def parse_args(train=True, one=False):
    """Particular configuration."""
    ...
    if train or not one:
        ...
        parser.add_argument('--label_filename', type=str,
                               help="Semantic segmentation mask filename. ")
        parser.add_argument('--style_filename', type=str,
                               help="Style filter filename if use VAE. ")
